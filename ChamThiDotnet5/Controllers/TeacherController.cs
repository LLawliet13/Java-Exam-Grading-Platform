...
namespace ChamThiDotnet5.Controllers
{
    public class TeacherController : Controller
    {
        ...
        public IActionResult Index(string ID)
        {
            ...
            if (addtest!=null) if(addtest.Equals("true"))
            {
                ViewData["AddExam"] = className + ": Add exam success! View detail in Exam Pending.";
        ...
        public IActionResult AddTest(string classid, string exam, string start, string end)
        {
            ...
            if (Classid != 0)
            {
                ...
                HttpContext.Session.SetString("addtest", "true");
            }
            idClass = classid;
